{{-- Panel keranjang: isinya disimpan di localStorage lewat bagian/skrip.blade.php --}}
<div id="latarKeranjang" class="fixed inset-0 z-[60] hidden bg-stone-950/50 backdrop-blur-sm" hidden></div>

<aside id="panelKeranjang" role="dialog" aria-modal="true" aria-labelledby="judulKeranjang" aria-hidden="true"
    ...
    <header class="flex items-center justify-between gap-4 border-b border-stone-100 px-6 py-5">
        <div>
            <h2 id="judulKeranjang" class="judul-besar text-2xl text-stone-900">Keranjang</h2>
            <p class="mt-1 text-sm text-stone-500"><span data-jumlah-keranjang>0</span> menu siap dipesan</p>
        </div>

        <button type="button" id="tutupKeranjang" aria-label="Tutup keranjang"
    ...
    <div id="isiKeranjang" class="flex-1 space-y-3 overflow-y-auto px-6 py-5"></div>

    {{-- Tampil saat keranjang kosong --}}
    <div id="keranjangKosong" class="flex flex-1 flex-col items-center justify-center gap-4 px-6 text-center">
    ...
    <footer id="kakiKeranjang" class="border-t border-stone-100 px-6 py-5">
        {{-- Kode promo dari halaman Promo --}}
        <div class="mb-4">
            <label for="kodePromo" class="block text-[11px] uppercase tracking-[0.18em] text-stone-500">Kode promo</label>

            <div id="formPromo" class="mt-2 flex gap-2">
                <input type="text" id="kodePromo" placeholder="Contoh: HEMAT14" autocomplete="off"
                ...
                <button type="button" id="pakaiPromo"
            ...
            <div id="promoTerpakai" class="mt-2 hidden items-center justify-between gap-3 rounded-xl border border-dashed border-neon-300 bg-neon-50 px-4 py-2.5">
                <span class="text-sm text-neon-800">
                    <span id="kodePromoTerpakai" class="font-semibold tracking-[0.1em]"></span>
                    <span id="labelPromoTerpakai" class="text-neon-700/80"></span>
                </span>
                <button type="button" id="hapusPromo" class="text-sm text-stone-500 underline-offset-2 transition hover:text-stone-800 hover:underline">
                    Hapus
                </button>
            </div>

            <p id="pesanPromo" class="mt-2 hidden text-sm"></p>
        </div>

        <div class="space-y-1.5 border-t border-stone-100 pt-4">
            <div class="flex items-baseline justify-between text-stone-500">
                <span>Subtotal</span>
                <span id="subtotalKeranjang">Rp 0</span>
            </div>

            <div id="barisDiskonKeranjang" class="flex hidden items-baseline justify-between text-neon-700">
                <span>Diskon</span>
                <span id="diskonKeranjang">&minus;Rp 0</span>
            </div>

            <div class="flex items-baseline justify-between pt-1">
                <span class="text-stone-500">Total</span>
                <span id="totalKeranjang" class="judul-besar text-2xl text-neon-600">Rp 0</span>
            </div>
        </div>

        <button type="button" id="lanjutKePembayaran"
        ...
        <button type="button" id="kosongkanKeranjang" class="mt-2 w-full rounded-full px-6 py-2.5 text-sm text-stone-500 transition hover:bg-stone-100 hover:text-stone-800">
            Kosongkan keranjang
        </button>
    </footer>
</aside>
...
<div id="notifikasi" role="status" aria-live="polite"
